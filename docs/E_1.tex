...
{\centering \includegraphics{E_1_files/figure-latex/99w-1} 

}

\caption{Regresión lineal}\label{fig:99w}
\end{figure}
...
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.28\columnwidth}\centering
\(f(100)=\ensuremath{1.37927\times 10^{5}}\)\strut
\end{minipage} & \begin{minipage}[t]{0.33\columnwidth}\centering
\(f(360)=\ensuremath{7.907036\times 10^{6}}\)\strut
\end{minipage} & \begin{minipage}[t]{0.30\columnwidth}\centering
\(f(370)=\ensuremath{8.602571\times 10^{6}}\)\strut
\end{minipage}\tabularnewline
\bottomrule
\end{longtable}
