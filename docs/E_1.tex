...
La función de densidad de probabilidad asociado a una variable aleatoria \(f(x)\)
...
\BeginKnitrBlock{definition}[Función de distribución]
\protect\hypertarget{def:unnamed-chunk-14}{}{\label{def:unnamed-chunk-14} \iffalse (Función de distribución) \fi{} }Sea \(X\) una variable aleatoria con función de densidad \(f(x)\). La función
...
\protect\hypertarget{def:unnamed-chunk-15}{}{\label{def:unnamed-chunk-15} \iffalse (Esperanza matemática de una variable aleatoria discreta) \fi{} }Sea
\EndKnitrBlock{definition}

\BeginKnitrBlock{definition}[Esperanza matemática de una variable aleatoria continua]
\protect\hypertarget{def:unnamed-chunk-16}{}{\label{def:unnamed-chunk-16} \iffalse (Esperanza matemática de una variable aleatoria continua) \fi{} }Sea
\EndKnitrBlock{definition}
...
\protect\hypertarget{def:unnamed-chunk-17}{}{\label{def:unnamed-chunk-17} \iffalse (Varianza de una variable aleatoria discreta) \fi{} }Sea
\EndKnitrBlock{definition}

\BeginKnitrBlock{definition}[Varianza matemática de una variable aleatoria continua]
\protect\hypertarget{def:unnamed-chunk-18}{}{\label{def:unnamed-chunk-18} \iffalse (Varianza matemática de una variable aleatoria continua) \fi{} }Sea
\EndKnitrBlock{definition}
...
\protect\hypertarget{def:unnamed-chunk-19}{}{\label{def:unnamed-chunk-19} \iffalse (Cuantiles de una variable aleatoria discreta) \fi{} }Sea
\EndKnitrBlock{definition}

\BeginKnitrBlock{definition}[Cuantiles matemática de una variable aleatoria continua]
\protect\hypertarget{def:unnamed-chunk-20}{}{\label{def:unnamed-chunk-20} \iffalse (Cuantiles matemática de una variable aleatoria continua) \fi{} }Sea
\EndKnitrBlock{definition}
...
\protect\hypertarget{def:unnamed-chunk-21}{}{\label{def:unnamed-chunk-21} \iffalse (Curtosis de una variable aleatoria discreta) \fi{} }Sea
\EndKnitrBlock{definition}

\BeginKnitrBlock{definition}[Curtosis de una variable aleatoria continua]
\protect\hypertarget{def:unnamed-chunk-22}{}{\label{def:unnamed-chunk-22} \iffalse (Curtosis de una variable aleatoria continua) \fi{} }Sea
\EndKnitrBlock{definition}
...
\protect\hypertarget{exm:unnamed-chunk-23}{}{\label{exm:unnamed-chunk-23} }Sean \(\begin{pmatrix} 3&-1&2\\ 2&-1&2\\ 1&-1&0\\ 5&0&0\\ \end{pmatrix}_{4\times 3}\) y \(\begin{pmatrix} 0&-1&2&2&0\\ 1&-1&-2&1&1\\ 3&-1&-3&5&2\\ \end{pmatrix}_{3\times 5}\) entonces \(A\cdot B=\begin{pmatrix} 5&-4&2&15&3\\ 5&-3&0&13&3\\ -1&0&4&1&-1\\ 0&-5&10&10&0\\ \end{pmatrix}_{4\times 5}\)
