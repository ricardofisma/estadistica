...
\caption{Regresion lineal}\label{fig:ww1w}
\end{figure}

\[f(x)=-28.285+11.351x+-0.906x^2+0.083x^3\]

\[f(28)=1392\]
\[f(29)=1553\]
\[f(300)=\ensuremath{2.1514155\times 10^{6}}\]
...
\hypertarget{discretas-1}{%
\section{Discretas}\label{discretas-1}}

\[p(x)=e^3\]

\hypertarget{continuas-1}{%
\section{Continuas}\label{continuas-1}}
...
\hypertarget{calculando-1}{%
\chapter{Calculando}\label{calculando-1}}

\hypertarget{variable-aleatoria-1}{%
\chapter{Variable aleatoria}\label{variable-aleatoria-1}}

\hypertarget{variable-acumulativa-1}{%
\chapter{Variable acumulativa}\label{variable-acumulativa-1}}
