...
\toprule
n & \(f\) & \(F_i\) & \(F_i*\) & \(h_i\) & \(H_i\) & \(H_i*\)\tabularnewline
\midrule
\endhead
1 & \(y_1\) & \(\sum_{i=1}^1y_i\) & e & ee & e & ee\tabularnewline
\bottomrule
\end{longtable}
...
\begin{longtable}[]{@{}lllllll@{}}
\toprule
Intervalo & Clase & \(f_i\) & \(F_i\) & \(h_i\) & \(H_i\) & \(H_i*\)\tabularnewline
\midrule
\endhead
\(<x_1-x_2>\) & \(y_1\) & \(f_1\) & \(F_1\) & \(h_1\) & ee & e\tabularnewline
\bottomrule
\end{longtable}
