...
{\centering \includegraphics[width=0.8\linewidth]{circunferencia} 
...
{\centering \includegraphics[width=0.8\linewidth]{vector} 
...
{\centering \includegraphics[width=0.8\linewidth]{parabola} 
...
{\centering \includegraphics[width=0.8\linewidth]{elipse} 
...
{\centering \includegraphics[width=0.8\linewidth]{hiperbola} 
