...
\begin{figure}
\centering
\includegraphics{z_1_files/figure-latex/cars-plot-1.pdf}
...
\hypertarget{ww}{%
\chapter*{ww}\label{ww}}
\addcontentsline{toc}{chapter}{ww}
...
\includegraphics{z_1_files/figure-latex/unnamed-chunk-6-1.pdf}
...
\includegraphics{z_1_files/figure-latex/unnamed-chunk-9-1.pdf}
...
\iffalse{} {Proof. } \fi{}En efecto \(0\in M\), \(0+1\in M\)
\EndKnitrBlock{proof}
