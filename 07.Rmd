...
Dos matrices son iguales si tienen el **mismo orden** y cada una de las entradas repsectivas son iguales es decir $A=[a_{ij}]_{n\times m}$ y $B=[b_{ij}]_{n\times m}$ son iguales si $a_{ij}=b_{ij}$, $i=1,2,\ldots n$ y $j=1,2,\ldots m$
...
3. El producto es posible si $n=p$ es decir el número columnas de la primera matriz es igual al número de filas de la segunda matriz, entonces 
\begin{align*}
