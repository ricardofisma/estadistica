...
<!-- ```{r nice1-fig, fig.cap='Here is a nice figure!', fig.asp=0.6, fig.width = 5, fig.align='center', echo=FALSE} -->
<!-- library(ggplot2) -->
<!-- set.seed(1234) -->
...
<!-- ```{r nice-fig, fig.cap='Here is a nice figure!', fig.asp=0.6, fig.width = 5, fig.align='center', echo=FALSE,warning = FALSE,message = FALSE} -->
<!-- library(extrafont) -->
<!-- library(tidyverse) -->
<!-- library(ggplot2) -->
...
<!-- ```{r nice3-fig, fig.cap='Here is a nice figure!', fig.asp=0.6, fig.width = 5, fig.align='center', echo=FALSE,warning = FALSE,message = FALSE} -->
<!-- library(extrafont) -->
<!-- library(tidyverse) -->
<!-- library(ggplot2) -->
