...
```{r www, fig.cap='Here is a nice figure 100!',  fig.width = 5, fig.asp=.5, fig.align='center', echo=FALSE,warning = FALSE,message = FALSE,tidy=FALSE}
library(extrafont)
library(tidyverse)
par(mar = c(4, 4, .1, .1))
plot(pressure, type = 'b', pch = 9, family = "serif")
text(200, 200, "Sans Italic text", font = 3)
text(80, 80, "Serif text", family = "Times New Roman")
```


```{r wwwww, fig.cap='Here is a nice figure 100!',  fig.width = 5, fig.asp=.5, fig.align='center', echo=FALSE,warning = FALSE,message = FALSE,tidy=FALSE}
library(extrafont)
library(tidyverse)
new <-read.xlsx(xlsxFile="levene.xlsx",sheet=11,cols=c(1:3),rows=c(2:33),colNames=FALSE)
new
Temperature <- new$X2
h <- hist(Temperature,ylim=c(0,20),breaks=5, family = "serif",
...
text(h$mids,h$counts,labels=h$counts, adj=c(0.5, -0.5), family = "serif")
```
Centering 
